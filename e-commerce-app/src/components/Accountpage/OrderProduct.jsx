        ...
        <>
            <div className="orderProductContainer" onClick={()=>{
                ...
                <div className="orderdetails">
                        ...
                        <p>{object.delivery_date===null?(<><span style={{color:"red"}}>Excepted Delivery {object.excepteddeliverydate.slice(0,15)}</span></>):(<>Date of delivery : {object.delivery_date.slice(0,15)}</>)}</p>
                    </div>
            </div>
        </>
    )
