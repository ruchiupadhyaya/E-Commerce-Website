                ...
                {full_data.isfull_data === false ? (
                    <div className="OrdersContainer">
                        {
                            object.orders.map((value, index) => {
                                return (<OrderProduct key={index} full_data={value} pdtId={value.pdt_id} image={value.image} pdtname={value.product_name} price={value.price} count={value.count} date_of_order={value.date_of_order} delivery_date={value.date_of_delivery} transaction_id={value._id} get_fulldata={get_fulldata} excepteddeliverydate={value.excepteddeliverydate} />)
                            })
                        }
                    ...
                    <div className="fullOrderdetails">
                        ...
                        <div className="orderdetails">
                            ...
                            <p>Date of order : {full_data.full_data.date_of_order.slice(0, 15)}</p>
                            <p>{full_data.full_data.date_of_delivery === null ? (<><span style={{ color: "red" }}>Excepted Delivery {full_data.full_data.excepteddeliverydate.slice(0, 15)}</span></>) : (<>Date of delivery : {full_data.full_data.date_of_delivery.slice(0, 15)}</>)}</p>
                                    ...
                                    <div className="ordered">
                                        ...
                                        <div className="box2">
                                            <div className="lighttext"> {
                                                `  ${full_data.full_data.date_of_order.slice(0, 25)}`
                                            }</div>
                                            <div className="lighttext">
                                            ...
                                            <>
                                                <div className="packing">
                                                    ...
                                                    <div className="box2">
                                                        <div className="lighttext">
                                                            {
                                                                `  ${full_data.full_data.packingdate.slice(0, 25)}`
                                                            }
                                                        </div>
                                                        <div className="lighttext">
                                            ...
                                            <>
                                                <div className="shipping">
                                                    ...
                                                    <div className="box2">
                                                        <div className="lighttext">
                                                            {
                                                                `  ${full_data.full_data.shippingdate.slice(0, 25)}`
                                                            }
                                                        </div>
                                                        <div className="lighttext">
                                            ...
                                            <>
                                                <div className="nearesthub">
                                                    <span className="lighttext">
                                                        ...
                                                        {
                                                            `  ${full_data.full_data.nearreachingdate.slice(0, 25)}`
                                                        }
                                                    </span>
                                                </div>
                                            </>
                                            ...
                                            <>
                                                <div className="outofdelivery">
                                                    <span className="lighttext">
                                                        ...
                                                        {
                                                            `  ${full_data.full_data.outofdelieverydatetime.slice(0, 25)}`
                                                        }
                                            ...
                                            <>
                                                <div className="delivered">
                                                    ...
                                                    <div className="box2">
                                                        <div className="lighttext">
                                                            {
                                                                ` at  ${full_data.full_data.date_of_delivery.slice(0, 25)}`
                                                            }
                                                        </div>
                                                        <div className="lighttext">
