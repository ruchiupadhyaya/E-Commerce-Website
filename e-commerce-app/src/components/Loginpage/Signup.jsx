            ...
            <div className="loginformContainer">
                <div className="loginform">
                    ...
                    <form method="POST" onSubmit={loginValidation}>
                        ...
                        <input type="password" name="password" id="password" placeholder="Enter Password" value={logindetails.password} onChange={setLoginData} required={true} autoComplete="off"/>
