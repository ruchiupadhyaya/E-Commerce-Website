...
function Register(object) {
    ...
    async function signupValidation(event) {
        ...
        if (signupdetails.otp === String(otp)) {
                    ...
                    <>
                        <div className="registerform">
                            ...
                            <form onSubmit={(event)=>{
                                ...
                                <input type="password" name="password" id="password" placeholder="Enter Password" value={signupdetails.password} onChange={setdata} required={true} autoComplete="off" />
